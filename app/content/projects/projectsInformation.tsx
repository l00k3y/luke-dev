...
export const ProjectInformation: ProjectType[] = [
  {
    title: "Frontend Optimisation & Accessibility Enhancements – Wild & Seek",
    description:
  ...
  {
    title:
      "Ecommerce Platform Migration & Frontend Optimisation – The Black Lash",
    description:
  ...
  {
    title: "Let’s Make Your Website Jealous of Itself – You’re Up Next!",
    description:
      "I’ve helped lashes sell, playgrounds book, and users stay happy. Now I’ve got room for one more awesome project. If your site needs a glow-up, a tune-up, or a full-on resurrection—I’m your guy. Let’s turn your idea into something slick, fast, and actually fun to use.",
    dates: "In the future",
    tags: [
      "Hire Me",
      "Let's Build Magic",
